...
namespace Editor.TrackEditor
{
    public class DistanceToPixelsConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture) =>
            TrackEditorVM.instance.DistanceToPixels((double)value);
    ...
    {
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture) =>
            TrackEditorVM.instance.OffsetToPixels((double)value);

        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
            => null;
    }

    public class TrackEditorVM : INotifyPropertyChanged
    {
        TrackEditorModel model = new TrackEditorModel();
        ...
        typeof(TrackEditorVM), new FrameworkPropertyMetadata(OnMainCanvasChanged));
        ...
        public static TrackEditorVM instance;
        public TrackEditorVM()
        {
            if (instance != null)
